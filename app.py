...
quiz_data = {
    "Math": [
        ...
        {"question": "7 × 2 = ?", "options": ["12", "14", "16", "18"], "answer": "14"},
    ],
    "Science": [
...
- Scores are saved to Google Sheets and leaderboard shown  
""")
...
# Auto-refresh (for timer countdown only)
